...
namespace SpurRoguelike
{
    internal class EntryPoint
    {
        ...
        public static void Main(string[] args)
        {
            ...
            commandLineParser
                 .Setup(options => options.TrainMode)
                .As('t')
                .SetDefault(false)
                .WithDescription("Train mode");

            if (commandLineParser.Parse(args).HelpCalled)
                return;
            if (commandLineParser.Object.TrainMode)
                Trainer.RunTrainer(commandLineParser.Object);
            else
                RunGame(commandLineParser.Object);
        }

        public static void  RunGame(GameOptions options)
        {
        ...
        internal static List<Level> GenerateLevels(int seed, int count)
        {
            ...
            levels[levels.Count-1 ].Number = levels.Count;
